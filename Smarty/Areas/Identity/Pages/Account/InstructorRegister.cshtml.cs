...
namespace Smarty.Areas.Identity.Pages.Account
{
    ...
    public class InstructorRegisterModel : PageModel
    {
        ...
        private readonly ILogger<InstructorRegisterModel> _logger;
        ...
        public InstructorRegisterModel(
            ...
            ILogger<InstructorRegisterModel> logger,
        ...
        [BindProperty]
        public InstructorRegisterFormViewModel ViewModel { get; set; }
